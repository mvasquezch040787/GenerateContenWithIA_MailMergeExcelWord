class Texts:
    ...
    ACCURACYIL_RECURSOS ="Genera Recursos digitales para el aprendizaje , Podrías recomendarme sitios web o plataformas donde pueda encontrar información precisa y actualizada, omite las palabras que describen los mismos como recurso o link , poner titulos o rotulos centrate en lo que se pide. incluye el nombre del recurso y link del mismo, verifica que los recursos y su link sean vigentes es decir que esten activos, de este tema e indicador de logro "   
    ACCURACY_INICIO ="Genera un inicio creativo para una sesión de aprendizaje, omite poner titulos o rotulos centrate en lo que se pide. Comienza con una intro de un parrafo, Luego plantea dos preguntas que despierten la curiosidad de los participantes y los conecten con el tema. Redacta en primera persona, para este tema e indicador de logro "
    ...
    ACCURACY_CIERRE="Generame el cierre de la sesion  de aprendizaje de manera detallada para este tema redactalo en primera persona omitiendo caracteres especiales, omite materiales, Concentrate solo en el cierre de las sesion"
